...
# Scrapy settings for weibophone project
#
...
SPIDER_MODULES = ['weibophone.spiders']
NEWSPIDER_MODULE = 'weibophone.spiders'


# Crawl responsibly by identifying yourself (and your website) on the user-agent
#USER_AGENT = 'weibophone (+http://www.yourdomain.com)'
...
#     'User-Agent': "Weibo/27005 (iPhone; iOS 11.3; Scale/2.00)",
#     'SNRT': "normal",
#     'Accept': "*/*",
...
#SPIDER_MIDDLEWARES = {
#    'weibophone.middlewares.WeibophoneSpiderMiddleware': 543,
#}
...
ITEM_PIPELINES = {
   'weibophone.pipelines.CheckItemPipeline': 200,
   'weibophone.pipelines.WeibophonePipeline': 300,
}
